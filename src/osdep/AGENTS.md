...
│   ├── uae4arm/                # UAE4Arm-owned shims should prefer src/uae4arm/, not osdep/
...
- UAE4Arm-owned separation helpers should prefer `src/uae4arm/` unless they are truly platform-layer code
